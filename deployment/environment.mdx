---
title: "Configure NodeForgeCMS Environment Variables"
sidebarTitle: "Environment"
description: "Set up your NodeForgeCMS server environment with database credentials, JWT secrets, Redis connection, and email settings."
---
