---
title: "Users API — Manage Admin Users in NodeForgeCMS"
sidebarTitle: "Users"
description: "REST endpoints for listing, creating, and managing admin users. All endpoints require a valid Bearer token with admin privileges."
---
...
| `role` | string | User role — `admin` or `editor` |
...
<ParamField body="password" type="string" required>
  Login password for the new account. A minimum of **8 characters** is strongly recommended. Passwords are stored as bcrypt hashes and are never returned in API responses.
</ParamField>
