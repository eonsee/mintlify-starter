---
title: "Deploy NodeForgeCMS with Docker Compose (MySQL + Redis)"
sidebarTitle: "Docker"
description: "Run NodeForgeCMS in isolated containers using the included Docker Compose configuration with MySQL 8 and Redis 7 — reproducible and fast to set up."
---
