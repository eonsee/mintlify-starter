---
title: "Configure Nginx for NodeForgeCMS"
sidebarTitle: "Nginx"
description: "Set up Nginx as a reverse proxy for NodeForgeCMS with configurations for separate-domain and shared-domain deployments."
---
...
If the project doesn't include an `ecosystem.config.js`, start the server directly:

```bash
pm2 start "node index.js" --name nodeforge-server
pm2 save
pm2 startup
```
